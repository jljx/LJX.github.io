...
const helpContent = {
	shellType: {
		header: '烟花类型',
		body: '你要放的烟花的类型，选择“随机（随机）”可以获得非常好的体验！'
	},
	shellSize: {
		header: '烟花大小',
...
const ghostShell = (size=1) => {
	...
	// 重影 effect can be fast, so extend star life
	shell.starLife *= 1.5;
	...
	// 重影 effect - transition from invisible to chosen color
...
const fastShellBlacklist = ['落叶', '花', '柳树'];
...
// 门耳 breaks star into four same-color pieces which branch in a cross-like shape.
...
// 爆裂 pops into a small cloud of golden sparks.
